...
def run_all():
    ...
    # JSON Serialization
    collect_group("JSON Serialization", {
        "Lodum": {
    ...
    collect_group("JSON Deserialization", {
        "Lodum": {
    ...
    # MsgPack
    if msgpack:
        collect_group("MsgPack Serialization", {
            "Lodum": {
        ...
        collect_group("MsgPack Deserialization", {
            "Lodum": {
    ...
    # CBOR
    if cbor2:
        collect_group("CBOR Serialization", {
            "Lodum": {
        ...
        collect_group("CBOR Deserialization", {
            "Lodum": {
    ...
    # YAML
    if ruamel.yaml:
        collect_group("YAML Serialization", {
            "Lodum": {
        ...
        collect_group("YAML Deserialization", {
            "Lodum": {
    ...
    # TOML
    if tomli_w:
        collect_group("TOML Serialization", {
            "Lodum": {
        ...
        collect_group("TOML Deserialization", {
            "Lodum": {
    ...
    # Pickle
    collect_group("Pickle Serialization", {
        "Lodum (Safe)": {
    ...
    collect_group("Pickle Deserialization", {
        "Lodum (Safe)": {
